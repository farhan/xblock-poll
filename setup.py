#!/usr/bin/env python
"""
Package metadata for poll_xblock.
"""
import os
import re
import sys
...
VERSION = get_version('poll_xblock', '__init__.py')
...
setup(
    name='poll-xblock',
    version=VERSION,
    description="""Poll XBlock""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Open edX Project',
    author_email='oscm@openedx.org',
    url='https://github.com/openedx/poll-xblock',
    packages=find_packages(
        include=['poll_xblock', 'poll_xblock.*'],
        exclude=["*tests"],
    ),
