...
"""
poll-xblock documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'poll-xblock',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/poll-xblock",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Poll XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'poll_xblock'),
                os.path.join(root_path, 'poll_xblock/migrations')])
